...
const STOCK_DETAIL_TOUR: TourStep[] = [
  {
    ...
    description: "주가와 거래량의 흐름을 시간 순서대로 보여줘요.",
    items: [
      "빨간 캔들 — 해당 구간에서 가격이 오른 경우예요",
      "파란 캔들 — 해당 구간에서 가격이 내린 경우예요",
      "아래 막대 — 해당 시간대의 거래량이에요",
      "오른쪽으로 갈수록 최근 데이터예요",
    ],
    placement: "bottom",
  },
  ...
  },
  {
    ...
    description: "이 종목의 보유 수량과 수익 상태를 확인하고 바로 주문할 수 있어요.",
    items: [
      "매수 — 이 종목을 사는 주문이에요",
      "매도 — 이 종목을 파는 주문이에요",
      "매수는 주문 가능 금액 안에서만 가능해요",
    ],
    placement: "left",
  },
  {
    ...
    description:
      "사려는 사람과 팔려는 사람이 각각 얼마에 주문을 내고 있는지 보여줘요.",
    items: [
      { label: "위쪽(매도호가)", labelColor: "#111827", text: "— 팔려는 주문 가격과 수량" },
      { label: "아래쪽(매수호가)", labelColor: "#111827", text: "— 사려는 주문 가격과 수량" },
      "테두리 행 — 현재 거래되는 가격",
      "오른쪽 숫자 — 해당 가격에 대기 중인 주문 수량. 막대 길이로도 한눈에 비교할 수 있어요",
      "호가를 누르면 해당 가격으로 주문을 할 수 있어요",
    ],
    placement: "left",
  },
];
