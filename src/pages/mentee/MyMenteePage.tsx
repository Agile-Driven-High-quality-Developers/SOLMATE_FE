...
const MENTEE_TOUR: TourStep[] = [
  {
    ...
    description: "나를 멘토로 등록한 멘티들을 확인할 수 있어요.",
    items: [
  ...
  },
  {
    ...
    description: "선택한 멘티의 투자 정보를 확인할 수 있어요.",
    items: [
      "포트폴리오 — 멘티가 보유한 종목 현황을 확인할 수 있어요.",
      "매매일지 — 멘티가 남긴 일지를 보고 댓글로 피드백을 남길 수 있어요.",
      "매매내역 — 멘티의 거래 기록을 볼 수 있어요.",
    ],
    placement: "left",
  },
];
